...
float Math::ease_in(float t, float b, float c, float d)
{
    t /= d;
    return c * t * t * t * t + b;
}

float Math::ease_out(float t, float b, float c, float d)
{
    t /= d;
    t = t - 1.0f;
...
float Math::ease_in_out(float t, float b, float c, float d)
{
    t /= d / 2.0f;
    if (t < 1.0f)
    {
